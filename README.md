# Classify App
Aplicaão web que classifica imagens.

## Introdução

Essa aplicação utiliza o TensorFlowJs e roda roda sob o modelo MobileNet.
...
Para executar a aplicação, navegue aé o diretório da aplicação pelo prompt de comando e execute o comando:
